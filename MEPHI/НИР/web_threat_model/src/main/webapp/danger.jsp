...
<form:form method="POST" action="danger"  modelAttribute="danger">
    ...
    <p><form:checkbox path="dangerString" value="high"/>Высокий</p>
    <p><form:checkbox path="dangerString" value="medium"/>Средний</p>
    <p><form:checkbox path="dangerString" value="low"/>Низкий</p>
