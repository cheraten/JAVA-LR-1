...
<form:form method="POST" action="sequritylevel"  modelAttribute="sequrityLevel">
    ...
    <p><form:radiobutton path="sequrityLevel1" value="low"/>Распределенная информационная система</p>
    ...
    <p><form:checkbox path="sequrityLevel2" value="medium"/>Суперкомпьютерные системы</p>
    ...
    <p><form:checkbox path="sequrityLevel3" value="medium"/>Система с прикладными программами, независимых от ОС</p>
    <p><form:checkbox path="sequrityLevel3" value="medium"/>Система, использующая выделенные каналы связи</p>
    ...
    <p><form:radiobutton path="sequrityLevel4" value="high"/>Не взаимодействует</p>
    ...
    <p><form:radiobutton path="sequrityLevel5" value="high"/>Не подключена</p>
    ...
    <p><form:radiobutton path="sequrityLevel6" value="low"/>Вне контролируемой зоны</p>

    <p><b>Режим обработки информации в системе:</b></p>
    <p><form:radiobutton path="sequrityLevel7" value="low"/>Многопользовательский</p>
    <p><form:radiobutton path="sequrityLevel7" value="high"/>Однопользовательский</p>
    ...
    <p><form:radiobutton path="sequrityLevel8" value="low"/>Не разграничиваются</p>
    ...
    <p><form:radiobutton path="sequrityLevel9" value="low"/>Не разделены</p>

    <p><b>Сегментирована ли информационная система?</b></p>
    <p><form:radiobutton path="sequrityLevel10" value="medium"/>Сегментирована</p>
    <p><form:radiobutton path="sequrityLevel10" value="low"/>Не сегментирована</p>
